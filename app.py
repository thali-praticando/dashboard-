...
if selected_chart == 'Histograma':
    ...
    hist = px.histogram(car_data, x='odometer', color='model_year', title='Histograma de Odômetro com Cores',
                        labels={'odometer': 'Odômetro'})
    # Exibir o histograma Plotly interativo
    st.plotly_chart(hist, use_container_width=True)
else:
    # Gráfico de dispersão com legenda e cores
    scatter = px.scatter(car_data, x='mileage', y='price', color='model_year', title='Gráfico de Dispersão: Preço x Quilometragem',
